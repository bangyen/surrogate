/* @ts-self-types="./chess_ai_rust.d.ts" */
...
export class WasmGame {
     ...
     */
    evaluate() {
        const ret = wasm.wasmgame_evaluate(this.__wbg_ptr);
        return ret;
    }
    /**
    ...
    explain(uci) {
        ...
        try {
            ...
            const ret = wasm.wasmgame_explain(this.__wbg_ptr, ptr0, len0);
            var ptr2 = ret[0];
            var len2 = ret[1];
            if (ret[3]) {
                ptr2 = 0; len2 = 0;
    ...
    featuresJson() {
        ...
        let deferred2_1;
        try {
            const ret = wasm.wasmgame_featuresJson(this.__wbg_ptr);
            var ptr1 = ret[0];
            var len1 = ret[1];
            if (ret[3]) {
                ptr1 = 0; len1 = 0;
    ...
    fen() {
        ...
        let deferred1_1;
        try {
            const ret = wasm.wasmgame_fen(this.__wbg_ptr);
            deferred1_0 = ret[0];
            deferred1_1 = ret[1];
     ...
     */
    hasModel() {
        const ret = wasm.wasmgame_hasModel(this.__wbg_ptr);
        return ret !== 0;
    }
    /**
     ...
     */
    isGameOver() {
        const ret = wasm.wasmgame_isGameOver(this.__wbg_ptr);
        return ret !== 0;
    }
    /**
    ...
    loadModel(model_json) {
        ...
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.wasmgame_loadModel(this.__wbg_ptr, ptr0, len0);
        if (ret[1]) {
    ...
    constructor(variant) {
        ...
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.wasmgame_new(ptr0, len0);
        if (ret[2]) {
     ...
     */
    playEngineMove(depth) {
        const ret = wasm.wasmgame_playEngineMove(this.__wbg_ptr, depth);
        if (ret[3]) {
            throw takeFromExternrefTable0(ret[2]);
        }
        let v1;
    ...
    playMove(uci) {
        const ptr0 = passStringToWasm0(uci, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.wasmgame_playMove(this.__wbg_ptr, ptr0, len0);
        if (ret[1]) {
            throw takeFromExternrefTable0(ret[0]);
        }
    }
     ...
     */
    searchMove(depth) {
        const ret = wasm.wasmgame_searchMove(this.__wbg_ptr, depth);
        let v1;
        if (ret[0] !== 0) {
            v1 = getStringFromWasm0(ret[0], ret[1]).slice();
            wasm.__wbindgen_free(ret[0], ret[1] * 1, 1);
    ...
    turn() {
        ...
        let deferred1_1;
        try {
            const ret = wasm.wasmgame_turn(this.__wbg_ptr);
            deferred1_0 = ret[0];
            deferred1_1 = ret[1];
            return getStringFromWasm0(ret[0], ret[1]);
        } finally {
...
export function supportedVariants() {
    const ret = wasm.supportedVariants();
    var v1 = getArrayJsValueFromWasm0(ret[0], ret[1]).slice();
    wasm.__wbindgen_free(ret[0], ret[1] * 4, 4);
    return v1;
}
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('chess_ai_rust_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
